            ...
            <div class="mr-3">
                <p class="text-sm text-gray-500 leading-5 dark:text-gray-400">
                    ...
                    @if ($paginator->firstItem())
                        ...
                        ～
                        <span class="font-medium">{{ $paginator->lastItem() }}件目</span>
                    @else
                        {{ $paginator->count() }}
                    @endif
                </p>
                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-gray-300 border border-gray-300 cursor-default leading-5 dark:bg-gray-800 dark:border-gray-600">{{ $page }}</span>
                                    </span>
                                @else
